...
export const Navigation: React.FC<NavigationProps> = ({ data }) => {
    ...
    const stripLinks = useMemo(() => navItems.filter((i) => !isCenterLabel(i.label)), [navItems, isCenterLabel])
            ...
            >
                ...
                <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                    ...
                    <div className="flex-grow text-center">
                        <span className="text-lg font-bold text-gray-800">{data.title || 'Menu'}</span>
                    </div>
                ...
                <div className="mt-8 w-full">
                    <CurateButton data={data} onClick={closeMobileMenu} />
                </div>
            </div>
        </div>
    )
