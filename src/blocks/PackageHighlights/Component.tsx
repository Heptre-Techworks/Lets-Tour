...
import type { PackageHighlightsBlock as PackageHighlightsBlockProps } from '@/payload-types';
...
export const PackageHighlights: React.FC<PackageHighlightsBlockProps> = ({
